        ...
        <div className="container mx-auto px-6 py-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              {createSpatialText(texts.access_location_exp[lang])}
              {createSpatialText(texts.access_address[lang])}
              {createSpatialText(texts.access_rooms[lang])}
              {createSpatialText(texts.access_tel[lang])}
              <div className="pt-4">
                <a
                ...
                >
                  {texts.access_accessmap_link2[lang]}
                </a>
              </div>
            </div>
            <div>{GoogleMap}</div>
